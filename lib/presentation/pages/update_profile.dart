...
class _UpdateScreenState extends State<UpdateScreen> {
  ...
  getData() async {
    ...
    surName.text = controller.user.surName;
    companyName.text = controller.user.companyName;
    location.text = controller.user.location;
                            ...
                            if (form!.validate()) {
                              ...
                              if (controller.signature &&
                                ...
                                User user = User(
                                    ...
                                    companyLogo: controller.companylogo == null
                                        ? controller.user.companyLogo
                ...
                builder: (con) {
                  return Row(
                    ...
                    children: [
                      Icon(
                        Icons.image,
                        color: con.companylogo != null || con.isCompanyLogo
                            ? greenColor
                            : primaryColor,
                      ),
                      const SizedBox(width: 10.0),
                      Text(
                        con.companylogo == null || con.isCompanyLogo
                            ? "Company Logo Picked"
                            : "Pick Company Logo",
                        style: TextStyle(
                          color: con.companylogo != null || con.isCompanyLogo
  ...
  Future<Uint8List> getCanvasImage(String str) async {
    var builder = ui.ParagraphBuilder(
        ui.ParagraphStyle(fontFamily: "Cursiv", fontSize: 20));
